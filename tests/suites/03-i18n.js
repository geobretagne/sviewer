...
var I18N_REQUIRED_KEYS = [
    ...
    'btn.where_am_i', 'btn.zoom_in', 'btn.zoom_out', 'btn.hint_dismiss',
    ...
    'msg.geolocation_failed', 'msg.geojson_http_error', 'msg.geojson_load_error',
    'msg.geojson_no_data', 'msg.gps_tracking_off', 'msg.gps_tracking_on',
    'msg.hint_click', 'msg.trust_badge',
    ...
    'msg.source', 'msg.source_url', 'msg.top_layer', 'msg.wms_error',
