 ...
 * Copy this file to connectors/{yourname}/adapter.js and adapt it.
 *
 * Demonstrates the minimal connector pattern:
 ...
 *
 * This format is intentionally simple — real connectors handle more complex
 * envelopes (see connectors/grist/adapter.js for a production example).
 *
